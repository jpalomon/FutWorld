...
//		
//		Manager jorgeJesus = new Manager("Jorge Jesus","Sporting de Lisboa","JorJes","splisb","ROLE_USER");
//		jorgeJesus.setEquipo(sportingLisboa);
//		managerRepository.save(jorgeJesus);
//		
//		Manager jorgeSimao = new Manager("Jorge Simao","Sporting de Braga","JorSim","scbra","ROLE_USER");
