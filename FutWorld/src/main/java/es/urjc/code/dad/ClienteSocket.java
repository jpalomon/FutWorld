...
public class ClienteSocket {
	...
	public void enviarInfoJugador(String nombreJugador, String equipoJugador, String posicion, int edad, String nacionalidadJugador, int valorMercado) {
		...
		try{
	      ...
	      escribirInfo.println("Nacionalidad Jugador: "+nacionalidadJugador+".");
	...
	public void recibirInfoJugador(String nombreJugador, String equipoJugador){
		...
		try{
		    ...
		    FileOutputStream fos = new FileOutputStream("fichas/"+equipoJugador+"/"+nombreJugador+".txt");
		    fos.write(bytes);
